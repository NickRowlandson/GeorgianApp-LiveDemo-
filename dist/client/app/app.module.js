System.register(["@angular/http", "@angular/core", "@angular/forms", "@angular/platform-browser", "ng2-charts/ng2-charts", "./app.component", "./app.routing", "primeng/primeng", "ng2-file-upload/file-upload/file-upload.module", "./components/login/login.component", "./components/dashboard/dashboard.component", "./components/staff-manage/staff-manage.component", "./components/staff-details/staff-details.component", "./components/student-manage/student-manage.component", "./components/client-status/client-status.component", "./components/suitability-form/suitability-form.component", "./components/consent-form/consent-form.component", "./components/case-notes/case-notes.component", "./components/course-manage/course-manage.component", "./components/course-edit/course-edit.component", "./components/prf-form/prf-form.component", "./components/learning-style-form/learning-style-form.component", "./components/student-enrollment/student-enrollment.component", "./components/timetable/timetable.component", "./components/attendance-list/attendance-list.component", "./components/attendance-report/attendance-report.component", "./components/reset-password/reset-password.component", "./components/file-upload/file-upload.component", "./components/files/files.component", "./components/help/help.component", "./components/not-found/not-found.component", "./components/wait-list/wait-list.component", "./components/site-activity/site-activity.component", "./components/student-archive/student-archive.component", "./pipes/user-filter.pipe", "./pipes/course-filter.pipe", "./pipes/campus-filter.pipe", "./pipes/student-to-select-item.pipe", "./pipes/instructor-to-select-item.pipe", "./pipes/course-to-select-item.pipe", "./pipes/course-type-to-select-item.pipe", "./guards/auth.guard", "./guards/admin.guard", "./guards/staff.guard", "./guards/student.guard", "./guards/client.guard", "./guards/instructor.guard", "./guards/shared.guard", "./services/authentication.service", "./services/student.service", "./services/client.service", "./services/staff.service", "./services/course.service", "./services/files.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var http_1, core_1, forms_1, platform_browser_1, ng2_charts_1, app_component_1, app_routing_1, primeng_1, primeng_2, primeng_3, primeng_4, primeng_5, primeng_6, primeng_7, primeng_8, primeng_9, primeng_10, primeng_11, primeng_12, file_upload_module_1, login_component_1, dashboard_component_1, staff_manage_component_1, staff_details_component_1, student_manage_component_1, client_status_component_1, suitability_form_component_1, consent_form_component_1, case_notes_component_1, course_manage_component_1, course_edit_component_1, prf_form_component_1, learning_style_form_component_1, student_enrollment_component_1, timetable_component_1, attendance_list_component_1, attendance_report_component_1, reset_password_component_1, file_upload_component_1, files_component_1, help_component_1, not_found_component_1, wait_list_component_1, site_activity_component_1, student_archive_component_1, user_filter_pipe_1, course_filter_pipe_1, campus_filter_pipe_1, student_to_select_item_pipe_1, instructor_to_select_item_pipe_1, course_to_select_item_pipe_1, course_type_to_select_item_pipe_1, auth_guard_1, admin_guard_1, staff_guard_1, student_guard_1, client_guard_1, instructor_guard_1, shared_guard_1, authentication_service_1, student_service_1, client_service_1, staff_service_1, course_service_1, files_service_1, AppModule;
    return {
        setters: [
            function (http_1_1) {
                http_1 = http_1_1;
            ...
            function (primeng_1_1) {
                ...
                primeng_12 = primeng_1_1;
            },
            function (file_upload_module_1_1) {
                file_upload_module_1 = file_upload_module_1_1;
            },
            ...
            function (student_to_select_item_pipe_1_1) {
                student_to_select_item_pipe_1 = student_to_select_item_pipe_1_1;
            },
            function (instructor_to_select_item_pipe_1_1) {
                instructor_to_select_item_pipe_1 = instructor_to_select_item_pipe_1_1;
            },
            function (course_to_select_item_pipe_1_1) {
                course_to_select_item_pipe_1 = course_to_select_item_pipe_1_1;
            },
            function (course_type_to_select_item_pipe_1_1) {
                course_type_to_select_item_pipe_1 = course_type_to_select_item_pipe_1_1;
            },
