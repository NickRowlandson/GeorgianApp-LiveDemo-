System.register(["@angular/http", "@angular/core", "@angular/forms", "@angular/platform-browser", "ng2-charts/ng2-charts", "./app.component", "./app.routing", "primeng/primeng", "ng2-file-upload/file-upload/file-upload.module", "./components/login/login.component", "./components/dashboard/dashboard.component", "./components/staff-manage/staff-manage.component", "./components/staff-details/staff-details.component", "./components/student-manage/student-manage.component", "./components/student-edit/student-edit.component", "./components/client-status/client-status.component", "./components/suitability-form/suitability-form.component", "./components/consent-form/consent-form.component", "./components/case-notes/case-notes.component", "./components/course-manage/course-manage.component", "./components/course-edit/course-edit.component", "./components/prf-form/prf-form.component", "./components/learning-style-form/learning-style-form.component", "./components/student-enrollment/student-enrollment.component", "./components/timetable/timetable.component", "./components/attendance-list/attendance-list.component", "./components/attendance-report/attendance-report.component", "./components/reset-password/reset-password.component", "./components/file-upload/file-upload.component", "./components/files/files.component", "./components/help/help.component", "./components/not-found/not-found.component", "./pipes/user-filter.pipe", "./pipes/course-filter.pipe", "./pipes/campus-filter.pipe", "./pipes/student-to-select-item.pipe", "./pipes/instructor-to-select-item.pipe", "./guards/auth.guard", "./guards/admin.guard", "./guards/staff.guard", "./guards/student.guard", "./guards/client.guard", "./guards/instructor.guard", "./guards/shared.guard", "./services/authentication.service", "./services/student.service", "./services/client.service", "./services/staff.service", "./services/course.service", "./services/files.service"], function (exports_1, context_1) {
    "use strict";
