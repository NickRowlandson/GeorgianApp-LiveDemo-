System.register(["@angular/core", "@angular/router", "../services/authentication.service"], function (exports_1, context_1) {
    ...
    var core_1, router_1, authentication_service_1, StudentGuard;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            StudentGuard = /** @class */ (function () {
                ...
                StudentGuard.prototype.canActivate = function () {
                    ...
                    if (userType === "Student" || userType === "Admin" || userType === "Instructor" || userType === "Staff") {
                        return true;
                    }
                    else {
            ...
            exports_1("StudentGuard", StudentGuard);
        }
    };
});
