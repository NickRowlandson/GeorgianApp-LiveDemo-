System.register(["@angular/router", "./guards/auth.guard", "./guards/admin.guard", "./guards/staff.guard", "./guards/student.guard", "./guards/client.guard", "./guards/instructor.guard", "./guards/shared.guard", "./components/login/login.component", "./components/dashboard/dashboard.component", "./components/staff-manage/staff-manage.component", "./components/staff-details/staff-details.component", "./components/student-manage/student-manage.component", "./components/student-edit/student-edit.component", "./components/client-status/client-status.component", "./components/suitability-form/suitability-form.component", "./components/consent-form/consent-form.component", "./components/case-notes/case-notes.component", "./components/course-manage/course-manage.component", "./components/course-edit/course-edit.component", "./components/prf-form/prf-form.component", "./components/learning-style-form/learning-style-form.component", "./components/student-enrollment/student-enrollment.component", "./components/timetable/timetable.component", "./components/attendance-list/attendance-list.component", "./components/attendance-report/attendance-report.component", "./components/reset-password/reset-password.component", "./components/file-upload/file-upload.component", "./components/files/files.component", "./components/help/help.component"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, auth_guard_1, admin_guard_1, staff_guard_1, student_guard_1, client_guard_1, instructor_guard_1, shared_guard_1, login_component_1, dashboard_component_1, staff_manage_component_1, staff_details_component_1, student_manage_component_1, student_edit_component_1, client_status_component_1, suitability_form_component_1, consent_form_component_1, case_notes_component_1, course_manage_component_1, course_edit_component_1, prf_form_component_1, learning_style_form_component_1, student_enrollment_component_1, timetable_component_1, attendance_list_component_1, attendance_report_component_1, reset_password_component_1, file_upload_component_1, files_component_1, help_component_1, appRoutes, routing;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
